...
impl FileManager {
        ...
        match path {
            ...
            "/home" => alloc::vec![
                ...
                FileEntry {
                    ...
                    path: String::from("/home/readme.txt"),
                    is_dir: false,
                    size: 1234,
                    modified: 0,
                    permissions: 0o644,
            ...
            "/models" => alloc::vec![
                FileEntry {
                    name: String::from("tinyllama-1.1b-q4.gguf"),
                ...
                FileEntry {
                    name: String::from("qwen2-0.5b-q4.gguf"),
                ...
                FileEntry {
                    name: String::from("whisper-tiny.gguf"),
    ...
    pub fn add_bookmark(&mut self, name: &str, path: &str) {
        self.bookmarks
            .push((String::from(name), String::from(path)));
    }
